...
export class GlobalState {
    ...
    constructor(game_info, scheme_data, natural_production_line, ui_settings) {
        ...
        this.natural_production_line = natural_production_line;
    ...
    calculate(needs_list) {
        let game_data = this.game_data;
        let natural_production_line = this.natural_production_line;
    ...
    #show_result_dict(result_dict) {
        ...
        let item_data = this.item_data;
        let item_graph = this.item_graph;
        let time_tick = this.ui_settings.time_tick;
        let mineralize_list = this.ui_settings.mineralize_list;
        let natural_production_line = this.natural_production_line;
    ...
    #show_surplus_list(lp_surplus_list) {
        var str = "";
