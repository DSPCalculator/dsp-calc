...
import {GameInfoContext} from './providers/app-contexts';
import {NeedsList} from '../features/needs/NeedsPanel';
import {NeedsListStorage} from '../features/needs/NeedsStorageControls';
import {GameVersion} from '../features/mod-selector/GameVersionSelector';
import {SchemeStorage} from '../features/settings/SchemeStorageControls';
import type {NumericMap} from '../types/domain';

const BatchSetting = lazy(() => import('../features/result/BatchPresetControls').then(module => ({default: module.BatchSetting})));
const Result = lazy(() => import('../features/result/ResultPanel').then(module => ({default: module.Result})));
const Settings = lazy(() => import('../features/settings/SettingsPanel').then(module => ({default: module.Settings})));
