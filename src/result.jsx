...
export {FactorySelect, ProModeSelect, ProNumSelect, RecipeSelect, pro_mode_class} from './recipe_selects.jsx';

// ValueWithDifference stays here (only used in result.jsx)
const ValueWithDifference = React.memo(function ValueWithDifference({currentValue, previousValue}) {
