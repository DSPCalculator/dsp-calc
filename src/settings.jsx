...
export function Settings() {
    ...
    return <div style={{display: 'flex', flexWrap: 'wrap'}}>
        ...
        <table>
            ...
            <tr>
                <td>配方显示</td>
                <td className="ps-2">{settings.show_effective_recipe ? "等效配方" : "原始配方"}</td>
                <td className="ps-2">
                    <button onClick={e => change_bool_setting(e, "show_effective_recipe")}>
                        {settings.show_effective_recipe ? "改为原始配方" : "改为等效配方"}
                    </button>
                </td>
            </tr>
            <tr>
