...
window.game_data = GameData.vanilla;//初始化配方、建筑、增产剂效果等默认游戏数据,本来应该存在json里的,html读本地json不方便,有大佬愿意重构一下也好,
...
function changeGameData() {
    ...
    init();
    calculate();
    document.getElementById("版本号").innerHTML = "版本号：" + game_data.Version;
}
...
window.mineralize = function (item) {
