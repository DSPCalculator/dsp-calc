...
import {normalizeFloatValue, normalizeIntValue, normalizePercentValue} from './settingFieldHelpers.js';
import {
    DISPLAY_AND_PROLIFERATION_ROWS,
    MINING_BEHAVIOR_ROWS,
    RESOURCE_PANEL_GROUPS,
    THEY_COME_FROM_VOID_ROWS
} from './settingsPanelConfig.js';
...
export function Settings() {
    ...
    function changePercentSetting(raw_value, name, min_value) {
        let val = normalizePercentValue(raw_value, DEFAULT_SETTINGS[name] * 100, min_value);
