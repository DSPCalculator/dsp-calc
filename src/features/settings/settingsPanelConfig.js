export const RESOURCE_PANEL_GROUPS = [
    {
        condition: () => true,
        rows: [
    ...
    {
        condition: ({genesis_enabled}) => genesis_enabled,
        rows: [
...
export const MINING_BEHAVIOR_ROWS = [
...
export const DISPLAY_AND_PROLIFERATION_ROWS = [
    {type: 'time_unit'},
...
export const THEY_COME_FROM_VOID_ROWS = [
