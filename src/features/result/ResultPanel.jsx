...
import {GlobalStateContext, SchemeDataSetterContext, SettingsSetterContext} from '../../app/providers/app-contexts.js';
import {NplRows} from './NaturalProductionLinesTable.jsx';
import {ResultSidebar} from './ResultSidebar.jsx';
import {buildSideProducts} from './resultGraphHelpers.js';
import {addMineralizedItem, clearMineralizedItems, removeMineralizedItem} from '../../core/calculation/mineralizeState.js';
import {buildResultRowActions} from './resultRowActions.js';
import {buildResultRowsViewModel} from './resultRowsViewModel.js';
import {ResultTableRow} from './ResultTableRow.jsx';
...
export function Result({needs_list, set_needs_list}) {
    ...
    let side_products = buildSideProducts(result_dict, item_graph);
