...
import {GlobalStateContext, SchemeDataSetterContext} from '../../app/providers/app-contexts';
import {HorizontalMultiButtonSelect} from '../../shared/ui/HorizontalMultiButtonSelect';
...
export function BatchSetting() {
    ...
    Object.keys(game_data.factory_data).forEach(factory => {
        ...
        if (list.length >= 2 && used_num >= 3) {
            factory_doms.push(<FactorySelect key={factory_kind} factory={factory_kind} list={list}/>);
        }
    });
