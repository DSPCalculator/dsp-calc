...
export function normalizeModSelection(current_mods, next_mods, game_data_info_list) {
    const modSet = new Set(next_mods);

    const MSGUID = game_data_info_list[1].name_en + game_data_info_list[1].version;
    const VDGUID = game_data_info_list[2].name_en + game_data_info_list[2].version;
    const GBGUID = game_data_info_list[3].name_en + game_data_info_list[3].version;
    const ORGUID = game_data_info_list[4].name_en + game_data_info_list[4].version;
