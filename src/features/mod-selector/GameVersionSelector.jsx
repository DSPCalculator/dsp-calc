...
} from '../../core/game-data/gameData.js';
import {DEFAULT_SETTINGS} from '../../app/providers/default-settings.js';
import {hasActiveProduction, isSameModSelection, normalizeModSelection} from './modSelectionRules.js';
import {init_scheme_data} from '../settings/schemeData.js';
...
export function GameVersion({needs_list, set_needs_list}) {
    ...
    async function mods_change(modList) {
        ...
        set_needs_list({});
        let modList2 = normalizeModSelection(mods, modList, game_data_info_list);
        ...
        let game_data = await get_game_data(modList2);
