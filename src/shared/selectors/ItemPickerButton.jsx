...
import {GameInfoContext} from '../../app/providers/app-contexts.js';
...
export function ItemSelect({item, set_item, text, btn_class, icon_size, icon_only}) {
    const ref = useRef();
